  ...
  return (
    <main className="flex min-h-screen items-center justify-center px-6 py-12">
      <div className="grid w-full max-w-5xl gap-6 lg:grid-cols-[1fr_0.9fr]">
        <Card className="border-white/12 border">
          <CardContent className="flex h-full flex-col justify-between gap-10 p-8">
            <div className="space-y-5">
              ...
              <div className="space-y-4">
                ...
                <h1 className="text-4xl font-[var(--font-heading)] font-semibold tracking-tight text-white md:text-[2.8rem]">
                  Access the seller workspace without visual noise.
                </h1>
                <p className="max-w-xl text-sm text-slate-300">
                  Sign in to connect PandaDoc and QuickBooks, sync invoices, and
                  move directly into the funding workflow. Secondary operator
                  detail stays available, but out of the main path.
                </p>
              </div>
            </div>
            <div className="grid gap-3 text-sm text-slate-300 md:grid-cols-3">
              <div className="rounded-[1rem] border border-white/12 bg-white/4 p-4">
                Step 1: connect systems
              </div>
              <div className="rounded-[1rem] border border-white/12 bg-white/4 p-4">
                Step 2: import eligible invoices
              </div>
              <div className="rounded-[1rem] border border-white/12 bg-white/4 p-4">
                Step 3: withdraw capital
              </div>
            </div>
          </CardContent>
        </Card>
